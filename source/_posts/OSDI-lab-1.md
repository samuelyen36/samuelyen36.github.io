---
title: OSDI_lab1
date: 2021-03-09 03:24:59
tags: OSDI
categories: 資工
description: bare-metal programming on Rpi3
---

## Overview
這次作業主要是要學生練習撰寫簡單的bootloader，以及如何在沒有OS的狀況下撰寫程式
看這篇文章可以考慮跟著reference的resource和我的github repository一起讀
這樣可能會比較知道在幹麻（？
...
## reference
[lab document](https://grasslab.github.io/NYCU_Operating_System_Capstone/labs/lab1.html)
這次作業大致follow這個 [toturial](https://github.com/s-matyukevich/raspberry-pi-os)
[my github repository](https://github.com/samuelyen36/osc2021)(in branch lab1)